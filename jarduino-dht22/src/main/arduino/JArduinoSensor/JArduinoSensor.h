...
#ifndef JArduinoSensor_h
#define JArduinoSensor_h
...
// Sensor read
extern void receivedigitalSensorRead(uint8_t pin, uint8_t sensor, uint8_t parametr);

class JArduinoSensor
{
  public:
	// Constructor
	JArduinoSensor();
    ...
    void senddigitalSensorReadResult(String value);
    void sendpinStateNotification(uint8_t pin, uint8_t state);
